...
ADMINS = (
    ...
    ('Rodrigo Garcia', 'rgarcia@inmegen.gob.mx'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'meddle',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '8mr36r7(+i0)4ebl*21x=b%t)h9jan1)_uepi&#1o)usgq$!0+'
...
ROOT_URLCONF = 'meddle.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'meddle.wsgi.application'
